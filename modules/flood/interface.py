...
class FloodSettings:
    ...
    def print_summary(self):
        ...
        print(f"  \033[93m|  \033[1mURL:\033[0m \033[93m{self.url}{
              ' ' * (len(self.url) + 14 - len(str(self.url)))}|\033[0m")
        print(f"  \033[93m|  \033[1mRequests:\033[0m \033[93m{self.num_requests}{
              ' ' * (len(self.url) + 9 - len(str(self.num_requests)))}|\033[0m")
        print(f"  \033[93m|  \033[1mThreads:\033[0m \033[93m{self.num_threads}{
              ' ' * (len(self.url) + 10 - len(str(self.num_threads)))}|\033[0m")
        print(f"  \033[93m|  \033[1mDelay:\033[0m \033[93m{self.delay_between_requests}{
              ' ' * (len(self.url) + 12 - len(str(self.delay_between_requests)))}|\033[0m")
        print(f"  \033[93m|  \033[1mRate Limit Delay:\033[0m \033[93m{self.rate_limit_timeout}{
              ' ' * (len(self.url) + 1 - len(str(self.rate_limit_timeout)))}|\033[0m")
        print(f"  \033[93m|{dashes}|\033[0m\n\n\n")
